...
cat("MSE for Boston Data using Lasso", rmse(boston.data.validation_1, lasso.model.data), "$\n")
cat("MSE for Boston Downtown Data using Lasso", rmse(boston.ddowntown.validation_1, lasso.model.ddowntown), "$\n")
cat("MSE for Boston Airport Data using Lasso", rmse(boston.dairport.validation_1, lasso.model.dairport), "$\n")
cat("MSE for Boston Both Data using Lasso", rmse(boston.dboth.validation_1, lasso.model.dboth), "$\n")
```
