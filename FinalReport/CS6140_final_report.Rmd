...
cat("MSE for Boston Data using Lasso - Validation Set 2", rmse(boston.dummied.validation_2, lasso.model.data), "$\n")
predict(lasso.model.data, s = bestlam.lasso.data, type = "coefficients")[1:63,]
```
