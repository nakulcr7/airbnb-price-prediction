...
plot(lasso.mod, main = "Lasso regression \n Boston Data", label = TRUE, xvar = "lambda", xlim = c(-5,15))

lasso.boston.ddowntown <- glmnet(x.boston.data,y.boston.ddowntown, alpha = 1, lambda = grid)
plot(lasso.mod, main = "Lasso regression \n Boston Downtown Distance", label = TRUE, xvar = "lambda", xlim = c(-5,15))

lasso.boston.dairport <- glmnet(x.boston.data,y.boston.dairport, alpha = 1, lambda = grid)
plot(lasso.mod, main = "Lasso regression \n Boston Airport Distance", label = TRUE, xvar = "lambda", xlim = c(-5,15))

lasso.boston.dboth <- glmnet(x.boston.data,y.boston.dboth, alpha = 1, lambda = grid)
