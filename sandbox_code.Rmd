...
if (file.exists("./data/boston_data.csv") && file.exists("./data/boston_data_undummied.csv") && !reprocess) {
  ...
  boston.dboth <- boston.undummied
  boston.dboth$ddowntown <- 0
  boston.dboth$dairport <- 0
    
  for (i in 1:nrow(boston.dboth)) {
    boston.dboth[i, "ddowntown"] <- to_downtown[normalize_neighborhood_name(boston.dboth[i, "neighborhood"])]
      boston.dboth[i, "dairport"] <- to_airport[normalize_neighborhood_name(boston.dboth[i, "neighborhood"])]
    }
