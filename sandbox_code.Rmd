...
if (!reprocess) {
  ...
  boston.undummied <- read.csv("./data/boston_undummied.csv", sep = ",", header=TRUE, na.strings=c("", " ", "NA"))
  ...
  boston.dboth_undummied$ddowntown <- 0
  boston.dboth_undummied$dairport <- 0
